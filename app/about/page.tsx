...
export const metadata = {
  title: "关于",
  description: `关于${site.name}：我是谁，以及这个站点是怎么搭起来的。`,
...
const SITE_FACTS = [
  ...
  { label: "框架", value: "Next.js 16 · React 19 · Tailwind CSS v4" },
  { label: "主题", value: "日间「竹林风」/ 夜间「星月夜」" },
  { label: "内容", value: "MDX · Shiki 代码高亮 · KaTeX 公式" },
  { label: "托管", value: "GitHub Pages · 免费且自带 HTTPS" },
  { label: "部署", value: "GitHub Actions · 推送即自动构建上线" },
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <section className="mb-16">
            ...
            <div className="space-y-4 text-body leading-relaxed max-w-2xl">
              <p>
                你好，我是 <span className="text-primary-strong font-medium">TsukiraLuna</span> 👋
                欢迎来到我的个人博客。这里记录我的学习笔记、技术折腾和一些杂想。
              </p>
              <p>
                这是一个纯静态的站点：写作在本地完成，构建时把每篇文章渲染成 HTML，
                部署后不需要服务器与数据库。
              </p>
              <p>
              ...
              <p>
                站点由 Hexo 迁移而来，现在是 <span className="text-primary-strong font-medium">Next.js 静态导出</span>
                ＋ MDX 写作，公式走 KaTeX，代码高亮走 Shiki。
              </p>
              <p>
